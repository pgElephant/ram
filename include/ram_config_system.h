 ...
 *
 * ram_config_system.h
 *		RAM configuration system with OS detection and platform-specific
 * defaults
 *
 ...
 */
int ram_config_load_with_defaults(ram_config_context_t* ctx,
 ...
 */
int ram_config_set(ram_config_context_t* ctx, const char* key,
                   const char* value);
 ...
 */
int ram_config_to_json(ram_config_context_t* ctx, char* json_buffer,
                       size_t buffer_size);
