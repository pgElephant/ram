...
extern bool quorum_selection_register_node(int32_t node_id, const char *hostname, int32_t port);
extern bool quorum_selection_unregister_node(int32_t node_id);
extern bool quorum_selection_update_node_health(int32_t node_id, float health_score);
...
extern bool quorum_selection_get_consensus_value(const char *key, char *value_out, size_t value_size);
extern bool quorum_selection_delete_consensus_value(const char *key);

/* Cluster management */
extern bool quorum_selection_get_cluster_state(quorum_cluster_state_t *state_out);
