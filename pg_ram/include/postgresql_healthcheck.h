...
extern bool
postgresql_healthcheck_run_single(const char* check_name,
                                  postgresql_healthcheck_result_t* result_out);

/* Specific health checks */
extern bool postgresql_healthcheck_database_connectivity(
    postgresql_healthcheck_result_t* result_out);
extern bool postgresql_healthcheck_replication_lag(
    postgresql_healthcheck_result_t* result_out);
extern bool
postgresql_healthcheck_disk_space(postgresql_healthcheck_result_t* result_out);
extern bool postgresql_healthcheck_memory_usage(
    postgresql_healthcheck_result_t* result_out);
extern bool postgresql_healthcheck_connection_limits(
    postgresql_healthcheck_result_t* result_out);
extern bool postgresql_healthcheck_wal_archiving(
    postgresql_healthcheck_result_t* result_out);
extern bool postgresql_healthcheck_vacuum_status(
    postgresql_healthcheck_result_t* result_out);
extern bool postgresql_healthcheck_lock_contention(
    postgresql_healthcheck_result_t* result_out);
extern bool postgresql_healthcheck_checkpoint_performance(
    postgresql_healthcheck_result_t* result_out);
extern bool postgresql_healthcheck_backup_status(
    postgresql_healthcheck_result_t* result_out);

/* Health check utilities */
extern bool postgresql_healthcheck_is_critical_failure(
    const postgresql_healthcheck_status_t* status);
extern float postgresql_healthcheck_calculate_score(
    const postgresql_healthcheck_status_t* status);
extern char* postgresql_healthcheck_get_summary(
    const postgresql_healthcheck_status_t* status);
