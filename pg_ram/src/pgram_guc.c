...
pgram_guc_init(void)
{
	DefineCustomIntVariable("pg_ram.node_id",
							"Node ID for librale",
							NULL,
							&pgram_node_id,
							DEFAULT_NODE_ID,
	...
	DefineCustomStringVariable("pg_ram.node_name",
							   "Node name for librale",
							   NULL,
							   &pgram_node_name,
							   DEFAULT_NODE_NAME,
							   PGC_POSTMASTER,
	...
	DefineCustomStringVariable("pg_ram.node_ip",
							   "Node IP for librale",
							   NULL,
							   &pgram_node_ip,
							   DEFAULT_NODE_IP,
	...
	DefineCustomIntVariable("pg_ram.rale_port",
							"RALE UDP port",
							NULL,
							&pgram_rale_port,
							DEFAULT_RALE_PORT,
	...
	DefineCustomIntVariable("pg_ram.dstore_port",
							"DStore TCP port",
							NULL,
							&pgram_dstore_port,
							DEFAULT_DSTORE_PORT,
	...
	DefineCustomStringVariable("pg_ram.db_path",
							   "Path for librale state/data under PGDATA by default",
							   NULL,
							   &pgram_db_path,
							   NULL,
							   PGC_POSTMASTER,
