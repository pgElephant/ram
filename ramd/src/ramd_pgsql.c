 ...
 *
 * pgsql.c
 *    PostgreSQL database interaction utilities for RAM shared library (libram),
 *    providing connection management, query execution, and database operations.
 *
 * Copyright (c) 2024-2025, pgElephant, Inc.
 *
 * IDENTIFICATION
 *    ram/libram/src/pgsql.c
 *
 *------------------------------------------------------------------------- */
#include <stdlib.h>
#include <time.h>
...
#include "ramd_log.h"
#include "ramd_parsing.h"
#include "ramd_pgsql.h"
#include "ramd_signals.h"
#include "ramd_string_utils.h"
...
/*
 * pgsql_check_postgresql_settings connects to our local PostgreSQL instance and
...
/*
 * pgsql_get_postgres_metadata returns several bits of incluster that we need
