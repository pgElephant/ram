...
bool ramd_maintenance_get_status(int32_t node_id, ramd_maintenance_state_t *state);

/* Pre-maintenance validation */
bool ramd_maintenance_pre_check(const ramd_maintenance_config_t *config, ramd_maintenance_check_t *checks);
...
bool ramd_maintenance_bootstrap_new_node(const ramd_config_t *config, 
...
bool ramd_maintenance_bootstrap_primary_node(const ramd_config_t *config,
                                            ...
                                            const char *primary_host,
                                            int32_t primary_port);
bool ramd_maintenance_bootstrap_cluster(const ramd_config_t *config,
                                       const char *cluster_name,
                                       const char *primary_host,
                                       int32_t primary_port,
...
bool ramd_maintenance_verify_cluster_health(const ramd_config_t *config,
                                           const char *primary_host,
                                           int32_t primary_port,
                                           const char **standby_hosts,
                                           int32_t *standby_ports,
...
/* Backup operations */
bool ramd_maintenance_create_backup(int32_t node_id, char *backup_id, size_t backup_id_size);
