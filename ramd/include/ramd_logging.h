...
extern bool ramd_logging_init(const char *log_file, ramd_log_level_t min_level,
							  bool log_to_file, bool log_to_syslog, bool log_to_console);
...
/* Convenience macros */
#define ramd_log_debug(...)   ramd_log(RAMD_LOG_LEVEL_DEBUG, __FILE__, __LINE__, __func__, __VA_ARGS__)
#define ramd_log_info(...)    ramd_log(RAMD_LOG_LEVEL_INFO, __FILE__, __LINE__, __func__, __VA_ARGS__)
#define ramd_log_notice(...)  ramd_log(RAMD_LOG_LEVEL_NOTICE, __FILE__, __LINE__, __func__, __VA_ARGS__)
#define ramd_log_warning(...) ramd_log(RAMD_LOG_LEVEL_WARNING, __FILE__, __LINE__, __func__, __VA_ARGS__)
#define ramd_log_error(...)   ramd_log(RAMD_LOG_LEVEL_ERROR, __FILE__, __LINE__, __func__, __VA_ARGS__)
#define ramd_log_fatal(...)   ramd_log(RAMD_LOG_LEVEL_FATAL, __FILE__, __LINE__, __func__, __VA_ARGS__)
