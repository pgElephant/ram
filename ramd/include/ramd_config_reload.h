...
bool ramd_config_reload_from_file(const char *config_file, ramd_config_reload_result_t *result);
...
bool ramd_config_validate_reload(const ramd_config_t *new_config, char *error_msg, size_t error_size);

/* Hot reload handlers for different subsystems */
bool ramd_config_reload_logging(const ramd_config_t *old_config, const ramd_config_t *new_config);
bool ramd_config_reload_monitoring(const ramd_config_t *old_config, const ramd_config_t *new_config);
bool ramd_config_reload_failover(const ramd_config_t *old_config, const ramd_config_t *new_config);
...
bool ramd_config_reload_sync_replication(const ramd_config_t *old_config, const ramd_config_t *new_config);
