...
bool ramctrl_daemon_wait_for_startup(ramctrl_context_t* ctx,
                                     int timeout_seconds);
bool ramctrl_daemon_wait_for_shutdown(ramctrl_context_t* ctx,
                                      int timeout_seconds);
...
bool ramctrl_daemon_generate_config(ramctrl_context_t* ctx,
                                    const char* config_file, int32_t node_id,
