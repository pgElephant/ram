...
extern bool ramctrl_database_demote_node(ramctrl_database_connection_t* conn,
                                         int32_t node_id);
extern bool
ramctrl_database_trigger_failover(ramctrl_database_connection_t* conn,
...
extern bool ramctrl_database_remove_node(ramctrl_database_connection_t* conn,
                                         int32_t node_id);
extern bool
ramctrl_database_enable_maintenance(ramctrl_database_connection_t* conn,
                                    int32_t node_id);
extern bool
ramctrl_database_disable_maintenance(ramctrl_database_connection_t* conn,
                                     int32_t node_id);

/* Monitoring and health checks */
extern bool
ramctrl_database_check_extension_installed(ramctrl_database_connection_t* conn);
extern bool
ramctrl_database_get_health_status(ramctrl_database_connection_t* conn,
                                   float* health_score);
extern bool
ramctrl_database_get_monitoring_data(ramctrl_database_connection_t* conn,
...
extern bool ramctrl_database_execute_query(ramctrl_database_connection_t* conn,
                                           ...
                                           size_t result_size);
extern bool
ramctrl_database_execute_function(ramctrl_database_connection_t* conn,
                                  const char* function_name, const char* args,
                                  char* result, size_t result_size);
